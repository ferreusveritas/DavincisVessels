...
public class DavincisVesselsConfig {
    ...
    public void addBlacklistWhitelistEntries() {
        MovingWorldLib.INSTANCE.getLocalConfig().addBlacklistedBlock(DavincisVesselsObjects.blockBuffer);

        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockMarkShip);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockCrateWood);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockFloater);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockBalloon);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockGauge);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockSeat);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockEngine);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockStickyBuffer);
        MovingWorldLib.INSTANCE.getLocalConfig().addWhitelistedBlock(DavincisVesselsObjects.blockAnchorPoint);
    }
    ...
    public void onConfigChange(ConfigChangedEvent.OnConfigChangedEvent event) {
        if (event.getModID().equals(ModConstants.MOD_ID)) {
