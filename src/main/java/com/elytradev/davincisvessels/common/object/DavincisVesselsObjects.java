...
public class DavincisVesselsObjects {
	...
	public static String REGISTRY_PREFIX = ModConstants.MOD_ID.toLowerCase();
	...
	public void init(FMLInitializationEvent e) {
		...
		GameRegistry.registerTileEntity(TileHelm.class, new ResourceLocation(ModConstants.MOD_ID, "archiHelm"));
		GameRegistry.registerTileEntity(TileGauge.class, new ResourceLocation(ModConstants.MOD_ID, "archiGauge"));
		GameRegistry.registerTileEntity(TileCrate.class, new ResourceLocation(ModConstants.MOD_ID, "archiCrate"));
		GameRegistry.registerTileEntity(TileEngine.class, new ResourceLocation(ModConstants.MOD_ID, "archiEngine"));
		GameRegistry.registerTileEntity(TileAnchorPoint.class, new ResourceLocation(ModConstants.MOD_ID, "archiAnchor"));
		GameRegistry.registerTileEntity(TileEntitySecuredBed.class, new ResourceLocation(ModConstants.MOD_ID, "archiSecuredBed"));
	}
	...
	public void onRecipeRegister(RegistryEvent.Register<IRecipe> recipeRegister) {
		...
		registerShapelessRecipe(recipeRegister.getRegistry(), new ItemStack(blockBuffer), blockFloater, "ingotIron");
	...
	private void registerShapedRecipe(IForgeRegistry<IRecipe> registry, ItemStack out, Object... input) {
		ResourceLocation resourceLocation = new ResourceLocation(ModConstants.MOD_ID, out.getUnlocalizedName() + recipeID++);
