...
import static com.elytradev.davincisvessels.movingworld.common.chunk.assembly.AssembleResult.ResultType.RESULT_NONE;
    ...
    public void blockAssembled(LocatedBlock locatedBlock) {
        ...
        if (block instanceof IBlockBalloon) {
            try {
            	...
            	DavincisVesselsMod.LOG.error("IBlockBalloon didn't check if something was null or not, report to mod author of the following block, " + block.toString());
            }
