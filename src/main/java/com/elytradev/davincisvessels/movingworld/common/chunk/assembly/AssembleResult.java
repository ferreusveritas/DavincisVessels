...
public class AssembleResult {
	...
	public EntityMovingWorld getEntity(World world, EntityMovingWorld entity) {
		...
		if (entity == null) {
			DavincisVesselsMod.LOG.error("A null movingWorld was attempted!");
			return null;
		}
		...
		try {
			...
			DavincisVesselsMod.LOG.error("Result code: RESULT ERROR OCCURRED was reached when attempting to getEntity from assembly result. Printing stacktrace...");
	...
	public TileEntity processTileEntity(TileEntity te) {
