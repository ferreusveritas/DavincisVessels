...
import com.elytradev.davincisvessels.movingworld.common.chunk.MovingWorldSizeOverflowException;
import com.elytradev.davincisvessels.movingworld.common.event.AssembleBlockEvent;
...
public class ChunkAssembler {
    ...
    public AssembleResult doAssemble(MovingWorldAssemblyInteractor interactor) {
        ...
        try {
            if (MovingWorldLib.INSTANCE.getLocalConfig().getShared().iterativeAlgorithm) {
            ...
            DavincisVesselsMod.LOG.error(e.toString());
        }
